...
/**
 * The routes an agent can call on this site: the markdown twin of every page, the discovery documents
 * and the MCP endpoint, described by nuxt-agent-discovery from the same route config that serves them.
 */

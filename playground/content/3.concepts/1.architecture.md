...
The webhook is required to advance the production pointer. ISR entries still expire after the `isr` window, but they render from the existing content SHA until a webhook refreshes it.

  ...
  >
    ...
    >
      ...
      <svg
        ...
        <svg v-else-if="mark === 'comark-content'" xmlns="http://www.w3.org/2000/svg" width="253" height="30" fill="none" viewBox="0 0 582 69" role="img" aria-label="Comark Content" style="position: absolute; top: 50px; left: 50px;">
